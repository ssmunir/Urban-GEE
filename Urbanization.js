...
var NOTurbanlagBYpop = function(currentUrbanLayer, pastUrbanLayer, populationLayer, yearlag, year) {
  ...
  var NoturbanTodayUrbanBefore = currentUrbanLayer.eq(1)        //  Urban areas today
      .and(pastUrbanLayer.eq(0));                          // Urban areas n years ago
...
// Create population urban layers for each year (current year) 
var popUrban_10YearLag2020 = NOTurbanlagBYpop(urban2020, urban2010, pop2020, 'popUrban_20YearLag_', '2020');
var popUrban_10YearLag2030 = NOTurbanlagBYpop(urban2020, urban2020, pop2030, 'popUrban_20YearLag_', '2030');
