...
##------------------------2010 - 2020---------------------------###
# main table 1  -- Region
t1regionCount = popData[["Region", "Population2010"]].groupby('Region').agg(['count']).reset_index()
# Subset 2010 and 2020 
t1region = popData[["Region", "Population2010","PopChange_2010-2020", "UrbanPopulation2010", "UrbanPopulation2020",  "UrbanPopulation_10YearLag2020", "NonUrbanPopulation_10YearLag2020"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2010"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2010 and 2020 
t1Incomegroup = popData[["Income group", "Population2010","PopChange_2010-2020", "UrbanPopulation2010", "UrbanPopulation2020", "UrbanPopulation_10YearLag2020", "NonUrbanPopulation_10YearLag2020"]].groupby("Income group").agg(["sum"]).reset_index()
...
# main table 2  -- Region
t1regionCount = popData[["Region", "Population2020"]].groupby('Region').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1region = popData[["Region", "Population2020","PopChange_2020-2030", "UrbanPopulation2020", "UrbanPopulation2030", "UrbanPopulation_10YearLag2030", "NonUrbanPopulation_10YearLag2030"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2020"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1Incomegroup = popData[["Income group", "Population2020","PopChange_2020-2030", "UrbanPopulation2020", "UrbanPopulation2030", "UrbanPopulation_10YearLag2030", "NonUrbanPopulation_10YearLag2030"]].groupby("Income group").agg(["sum"]).reset_index()
...
# main table 3  -- Region
t1regionCount = popData[["Region", "Population2000"]].groupby('Region').agg(['count']).reset_index()
# Subset 2000 and 2020 
t1region = popData[["Region", "Population2000","PopChange_2000-2020", "UrbanPopulation2000", "UrbanPopulation2020", "UrbanPopulation_20YearLag2020", "NonUrbanPopulation_20YearLag2020"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2000"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1Incomegroup = popData[["Income group", "Population2000","PopChange_2000-2020", "UrbanPopulation2000", "UrbanPopulation2020", "UrbanPopulation_20YearLag2020", "NonUrbanPopulation_20YearLag2020"]].groupby("Income group").agg(["sum"]).reset_index()
...
t1region = popData[["Region", "Population2010","PopChange_2010-2030", "UrbanPopulation2010", "UrbanPopulation2030", "UrbanPopulation_20YearLag2030", "NonUrbanPopulation_20YearLag2030"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2010"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1Incomegroup = popData[["Income group", "Population2010","PopChange_2010-2030", "UrbanPopulation2010", "UrbanPopulation2030", "UrbanPopulation_20YearLag2030", "NonUrbanPopulation_20YearLag2030"]].groupby("Income group").agg(["sum"]).reset_index()
...
t1regionCount = popData[["Region", "Population2010"]].groupby('Region').agg(['count']).reset_index()
# Subset 2010 and 2020 
t1region = popData[["Region", "Population2010","PopChange_2010-2020", "c1UrbanPopChange_2010-2020", "c2UrbanPopChange_2010-2020",  "c3UrbanPopChange_2010-2020"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2010"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2010 and 2020 
t1Incomegroup = popData[["Income group", "Population2010","PopChange_2010-2020", "c1UrbanPopChange_2010-2020", "c2UrbanPopChange_2010-2020",  "c3UrbanPopChange_2010-2020"]].groupby("Income group").agg(["sum"]).reset_index()
...
t1regionCount = popData[["Region", "Population2020"]].groupby('Region').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1region = popData[["Region", "Population2020","PopChange_2020-2030", "c1UrbanPopChange_2020-2030", "c2UrbanPopChange_2020-2030",  "c3UrbanPopChange_2020-2030"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2020"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2020 and 2030 
t1Incomegroup = popData[["Income group", "Population2020","PopChange_2020-2030", "c1UrbanPopChange_2020-2030", "c2UrbanPopChange_2020-2030",  "c3UrbanPopChange_2020-2030"]].groupby("Income group").agg(["sum"]).reset_index()
...
t1regionCount = popData[["Region", "Population2000"]].groupby('Region').agg(['count']).reset_index()
# Subset 2000 and 2020 
t1region = popData[["Region", "Population2000","PopChange_2000-2020", "c1UrbanPopChange_2000-2020", "c2UrbanPopChange_2000-2020",  "c3UrbanPopChange_2000-2020"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2000"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2000 and 2020 
t1Incomegroup = popData[["Income group", "Population2000","PopChange_2000-2020", "c1UrbanPopChange_2000-2020", "c2UrbanPopChange_2000-2020",  "c3UrbanPopChange_2000-2020"]].groupby("Income group").agg(["sum"]).reset_index()
...
t1regionCount = popData[["Region", "Population2010"]].groupby('Region').agg(['count']).reset_index()
# Subset 2010 and 2030 
t1region = popData[["Region", "Population2010","PopChange_2010-2030", "c1UrbanPopChange_2010-2030", "c2UrbanPopChange_2010-2030",  "c3UrbanPopChange_2010-2030"]].groupby('Region').agg(['sum']).reset_index()
...
t1IncomegroupCount = popData[["Income group", "Population2010"]].groupby('Income group').agg(['count']).reset_index()
# Subset 2010 and 2030 
t1Incomegroup = popData[["Income group", "Population2010","PopChange_2010-2030", "c1UrbanPopChange_2010-2030", "c2UrbanPopChange_2010-2030",  "c3UrbanPopChange_2010-2030"]].groupby("Income group").agg(["sum"]).reset_index()
